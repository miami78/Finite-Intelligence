...
+function(a) {
    ...
    c.prototype.backdrop = function(b) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            this.$element.on("mousedown.dismiss.bs.modal", a.proxy(function(a) {
...
+function(a) {
    ...
    c.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (j) {
                ...
                h = "bottom" == h && k.top + k.height + m - p.scroll > p.height ? "top" : "top" == h && k.top - p.scroll - m < 0 ? "bottom" : "right" == h && k.right + l > p.width ? "left" : "left" == h && k.left - l < p.left ? "right" : h,
    ...
    c.prototype.hide = function() {
        ...
        f.isDefaultPrevented() ? void 0 : (e.removeClass("in"),
        a.support.transition && this.$tip.hasClass("fade") ? e.one("bsTransitionEnd", b).emulateTransitionEnd(c.TRANSITION_DURATION) : b(),
